...
Original file is located at
    https://colab.research.google.com/drive/1RcXTl7T34juxavMJL5RpYgO4EsBO8pTX
"""
...
xgb_model = joblib.load('gender_model.pkl')
...
def predict(long_hair, nose_wide, nose_long, lips_thin, distance_nose_to_lip_long, forehead_width_cm, forehead_height_cm):
    ...
    x_data = stdscale.fit_transform(pd.DataFrame[long_hair, nose_wide, nose_long, lips_thin, distance_nose_to_lip_long, forehead_width_cm, forehead_height_cm],
                                   columns= ['long_hair', 'nose_wide', 'nose_long', 'lips_thin', 'distance_nose_to_lip_long', 'forehead_width_cm', 'forehead_height_cm'])
...
if st.button('Predict Gender'):
    Gender = predict(long_hair, nose_wide, nose_long, lips_thin, distance_nose_to_lip_long, forehead_width_cm, forehead_height_cm)
    if Gender == 0:
        Gender = "Female"
    else:
        Gender = "Male
